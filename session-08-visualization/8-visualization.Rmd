...
advanced_scatter <- ggplot(penguins, aes(x = flipper_length_mm, y = body_mass_g, color = species)) +
  geom_point() + 
  labs(title = "Basic plot", x = "Flipper Length", y = "Body Mass in grams") +
  theme_minimal()
...
ggplot(penguins, aes(x=body_mass_g)) +
  geom_histogram(bins = 18, fill = "#FF6666")
...
ggplot(globalpop,
  ...
  geom_col(position = position_dodge()) + # dodge to avoid stacked bars 
  theme_minimal()
```
...
ggplot(penguins, aes (x= flipper_length_mm, y = body_mass_g, color = species)) +
  geom_point() +
  geom_smooth(method = "lm") +
  labs(x= "flipper length in mm", y = "body mass in grams", title = "Body mass vs. flipper length")
...
```{r, warning = F, message = F, fig.height = 9, fig.width = 8}
df_brics <- df|>
  subset(country %in% c("Brazil", "India", "China", "South Africa"))

View(df_brics)

ggplot(df_brics, aes(x = year, y = gdpPercap)) +
  geom_line() +
  geom_point() +
  labs(title = "development of GDP per capita 1952-2007",
       subtitle = "Data source: Gapminder package",
       x = "Year",
