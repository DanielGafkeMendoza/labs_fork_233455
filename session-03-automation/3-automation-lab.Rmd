...
we want to group data in a dataframe and then pack it in a cell
...
penguins_nested <- penguins_nested |>
  mutate(bill_stats = map(data, summarize_bills)) # data: because the single dataframes in penguins_nested are called that now 
...
would probably integrate the script in the process data file
